...
<div class="main">
                ...
                <div id="sidebar">
                                ...
                                <div id="editor">
                                      <div id="css">
                                          <form id="exam_form" method="POST" action="/check2" class="form-horizontal" >
                                            @csrf
                                           ...
                                           <div class="line-numbers">
                                              ...
                                              <div class="coding-1">
                                               ...
                                               <pre id="before"<pre><</pre>html 
                                               
   
   
                                               <input   name="answer_2" type="text" class="check003" id="input004" required />
                                               ...
                                               <div class="coding-1">
                                                  ...
                                                  <div class="coding-1">
                                                      ...
                                                      <div class="coding-1">
                                                       ...
                                                       <div id="disappear001">
                                                         <div id="center001">
                                                            <button type="submit" class="button001" onclick="submit002()">Submit</button>
                                                          </div></div><br />
        ...
        <div style="width: 400px; margin-left: 46px;" id="exam">
            <div id="head"> 
              ...
              <div id="SpeechBubble">language tag is really important !! {{(Auth::user()->name)}} </div>
